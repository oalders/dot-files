...
alias tidy-test-imports="find t -type f | grep .t$ | xargs -L 1 perlimports --libs lib,t/lib -i -v --ignore-modules Test::More -f"
alias tidy-lib-imports="find lib -type f | grep .pm$ | xargs -n 1 perlimports -i -v --libs lib -f"
