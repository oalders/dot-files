...
git config --global alias.dom 'diff -w -M --relative origin/master...HEAD'
git config --global alias.doms 'diff -w -M --relative origin/master...HEAD --stat'
git config --global alias.domo 'diff -w -M --relative origin/master...HEAD --name-only'
